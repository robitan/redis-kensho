...
CMD="python3 ./src/redis_hash.py 3 3 100 10 30 True"
...
CMD="python3 ./src/redis_hash.py 3 3 100 20 20 True"
...
CMD="python3 ./src/redis_hash.py 3 3 100 40 40 False"
...
CMD="python3 ./src/redis_hash.py 3 3 100 50 80 False"
...
CMD="python3 ./src/redis_hash.py 3 3 100 70 70 False"
